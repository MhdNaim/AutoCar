<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vendor.aspx.cs" Inherits="AutoCar.html.vendor" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background-color: #062e33;">
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" style="color: #f2dd80;" id="offcanvasDarkNavbarLabel">Vendor</h5>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu " style="background-color: #062e33;">
                                        <li><a class="link" href="spareParts.aspx">Spare Part's Ordering <i class="fas fa-plus-circle"></i></a></li>
                                        <li>
